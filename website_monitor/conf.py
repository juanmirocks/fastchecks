...
def get_typed_envar(envar_name: str, default: _CONVERSION_OUTPUT, conversion: Callable[[str], _CONVERSION_OUTPUT]) -> _CONVERSION_OUTPUT:
    """
...
def read_envar_value(envar_name: str, envar_value: _CONVERSION_OUTPUT | None, raise_error_if_none: bool = True) -> _CONVERSION_OUTPUT:
    """
...
def get_postgres_conninfo() -> str:
    ...
    """
    return read_envar_value("_POSTGRES_CONNINFO",
                            _POSTGRES_CONNINFO, raise_error_if_none=True)
